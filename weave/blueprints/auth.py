...
bp.add_url_rule(
    "/api/auth/find-username", view_func=ar.auth_find_username, methods=["POST"]
)
bp.add_url_rule(
    "/api/auth/reset-password", view_func=ar.auth_reset_password, methods=["POST"]
)
bp.add_url_rule(
    "/api/auth/unlock-account", view_func=ar.auth_unlock_account, methods=["POST"]
)
